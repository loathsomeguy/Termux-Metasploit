...
clear
echo;
#(apt update;apt install wget busybox -y;wget -O $TMPDIR/metasploit.txt https://raw.githubusercontent.com/loathsomeguy/Termux-Metasploit/main/logo.txt) &> /dev/null
...
#wget -O "$TMPDIR"/msfconsole.sh https://raw.githubusercontent.com/loathsomeguy/Termux-Metasploit/main/msfconsole
# patch
# Wrapper.
